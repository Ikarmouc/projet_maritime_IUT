 ...
 */
final class Version20210405221310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bateau (id INT NOT NULL, musee_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, materiau VARCHAR(255) NOT NULL, prix_achat DOUBLE PRECISION NOT NULL, longueur DOUBLE PRECISION NOT NULL, largeur DOUBLE PRECISION NOT NULL, poids DOUBLE PRECISION NOT NULL, capacite_personne INT NOT NULL, temoignage_audio VARCHAR(255) NOT NULL, temoignage_texte LONGTEXT NOT NULL, INDEX IDX_A664B05AD90009CE (musee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE histoire_bateau (id INT NOT NULL, bateau_id INT NOT NULL, annee_lancement DATE NOT NULL, constructeur VARCHAR(255) NOT NULL, proprietaire VARCHAR(255) NOT NULL, annee_entree_collection DATE NOT NULL, date_monument_historique DATE NOT NULL, annee_restauration DATE NOT NULL, historique LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_3226D044A9706509 (bateau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE musee (id INT NOT NULL, addresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, jours_fermeture VARCHAR(255) NOT NULL, horaire_ouverture INT NOT NULL, horaire_fermeture INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
